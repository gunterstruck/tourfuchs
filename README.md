...
| 👥 **Filter** | **Vertriebsbezirk** ist die führende Ebene. Eine Auswahl isoliert auf der Gebietskarte auch die passenden Flächen, Beschriftungen und Legendeneinträge; die Gebietsflächen lassen sich zusätzlich mit einem eigenen Schalter komplett ausblenden. Vertriebsgruppe kann zusätzlich eingeblendet werden; weitere optionale Ebenen lassen sich bei Bedarf ergänzen. Kundenzähler helfen beim schnellen Prüfen der Verteilung |
